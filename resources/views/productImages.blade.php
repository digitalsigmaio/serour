            ...
            <div class="panel-body">
                <div class="padd">
                    ...
                    <div class="form quick-post">
                        ...
                        <form class="form-horizontal" action="{{ route('newProductImage', compact('product')) }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    ...
                    @if(count($images))
                        @foreach($images as $image)
                            <tr>
                                ...
                                <td><a href="{{ route('editProductImage', compact(['product', 'image'])) }}"><span class="btn btn-info">Edit</span></a></td>
                                <td>
                                    <form action="{{ route('deleteProductImage', compact(['product', 'image'])) }}" method="post">
                                        {{ csrf_field() }}
